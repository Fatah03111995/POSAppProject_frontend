...
//cashier name
  ...
  Future<List<int>> printReceiptCashierShiftOpen({
    ...
    // Header
    bytes += generator.text('CASHIER SHIFT',
        styles: const PosStyles(
          bold: true,
          align: PosAlign.center,
          height: PosTextSize.size1,
    ...
    // Waktu buka shift
    bytes += generator.text(
      'Open: ${DateFormat('dd-MM-yyyy HH:mm').format(openTime)}',
    ...
    bytes += generator.row([
      PosColumn(
          ...
          styles: const PosStyles(align: PosAlign.left)),
      PosColumn(
          text: openAmount.currencyFormatRpV2,
          width: 6,
          styles: const PosStyles(align: PosAlign.right)),
    ]);
    ...
    // Waktu dan kasir
    bytes += generator.text(
      DateFormat('dd-MM-yyyy HH:mm').format(openTime),
      styles: const PosStyles(align: PosAlign.left),
    );
    bytes += generator.feed(1);
    bytes += generator.text(
  ...
  Future<List<int>> printCashierShiftClose({
    required String cashierName,
    ...
    // Tanggal tutup shift
    bytes += generator.text(
        'Date: ${DateFormat('dd-MM-yyyy HH:mm').format(closedAt)}',
        styles: const PosStyles(align: PosAlign.center));
    bytes += generator.feed(1);
    ...
    bytes += generator.text(
      DateFormat('dd-MM-yyyy HH:mm').format(openAt),
    );
    bytes += generator.feed(1);
    ...
    bytes += generator.row([
      PosColumn(
          ...
          styles: const PosStyles(align: PosAlign.left)),
      PosColumn(
          text: (cashSales ?? 0).currencyFormatRpV2,
          width: 6,
          styles: const PosStyles(align: PosAlign.right)),
    ]);
    bytes += generator.feed(1);
    ...
    bytes += generator.row([
      PosColumn(
          ...
          styles: const PosStyles(align: PosAlign.left)),
      PosColumn(
          text: closeAmount.currencyFormatRpV2,
          width: 6,
          styles: const PosStyles(align: PosAlign.right)),
    ]);
    bytes += generator.text(
    ...
    bytes += generator.row([
      PosColumn(
          ...
          styles: const PosStyles(align: PosAlign.left)),
      PosColumn(
          text: (difference ?? 0).currencyFormatRpV2,
          width: 6,
          styles: const PosStyles(align: PosAlign.right)),
    ]);
